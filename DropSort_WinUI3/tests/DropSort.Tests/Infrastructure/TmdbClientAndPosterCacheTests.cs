...
public class TmdbClientAndPosterCacheTests : IDisposable
{
    ...
    [Theory]
    [InlineData(HttpStatusCode.Unauthorized, 401, false, "Invalid TMDB API credentials.")]
    [InlineData(HttpStatusCode.TooManyRequests, 429, false, "TMDB rate limit exceeded.")]
