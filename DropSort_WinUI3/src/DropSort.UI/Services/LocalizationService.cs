...
public static class LocalizationService
{
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>
    {
        ...
        ["SeasonWatchedFormat"] = "1 season · {0}/{1} watched",
        ["SeasonsWatchedFormat"] = "{0} seasons · {1}/{2} watched",
        ...
        ["CheckIssuesFormat"] = "{0} of {1} movies need attention.",
        ...
        ["SeasonMetaFormat"] = "{0} episodes · {1} watched · {2} local",
    ...
    private static readonly IReadOnlyDictionary<string, string> Arabic = new Dictionary<string, string>
    {
        ...
        ["SeasonWatchedFormat"] = "موسم واحد · {0}/{1} مشاهَد",
        ["SeasonsWatchedFormat"] = "{0} مواسم · {1}/{2} مشاهَد",
        ...
        ["SeasonMetaFormat"] = "{0} حلقة · {1} مشاهَدة · {2} محلية",
