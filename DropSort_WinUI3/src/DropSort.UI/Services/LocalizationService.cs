...
public static class LocalizationService
{
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>
    {
        ...
        ["ReadAccessTokenHelp"] = "Held in memory for this session only. Never saved to the library database.",
        ...
        ["TmdbSessionConfigured"] = "Configured for this session",
        ["MetadataAuthenticationError"] = "TMDB rejected the credential. Check your token in Settings.",
        ["MetadataRateLimitError"] = "TMDB is receiving too many requests. Wait a moment and retry.",
        ["MetadataNetworkError"] = "Cannot reach TMDB. Check your internet connection and retry.",
        ["MetadataTimeoutError"] = "The TMDB request timed out. Please retry.",
        ["MetadataApiError"] = "TMDB could not complete the request. Please try again later.",
        ["MetadataInvalidResponseError"] = "TMDB returned an unreadable response. Please retry.",
        ["MetadataNotFoundError"] = "This item is no longer available from TMDB. Try finding another match.",
        ["MetadataIncompleteError"] = "TMDB did not return all requested details. The match was not changed. Please retry.",
        ["MetadataStaleRequestError"] = "This record changed while metadata was loading. Review the current record and retry.",
        ["MetadataCancelled"] = "The metadata request was cancelled.",
        ["MetadataUnexpectedError"] = "The operation could not be completed. Please retry.",
        ["RelinkFailedHelp"] = "Could not relink the file. Choose an accessible file of the expected size that is not linked to another record, then retry.",
        ["CrashTempTitle"] = "Temporary files need review",
        ["CrashTempHelp"] = "Found {0} possible interrupted-transfer files. They were not changed or deleted; review them with the operation log before taking action.",
        ["FixMatch"] = "Fix match…",
    };
    ...
    private static readonly IReadOnlyDictionary<string, string> Arabic = new Dictionary<string, string>
    {
        ...
        ["ReadAccessTokenHelp"] = "يُحتفظ به في الذاكرة لهذه الجلسة فقط، ولا يُحفظ في قاعدة بيانات المكتبة.",
        ...
        ["TmdbSessionConfigured"] = "مُعدّ لهذه الجلسة",
        ["MetadataAuthenticationError"] = "رفض TMDB بيانات الاعتماد. تحقق من الرمز في الإعدادات.",
        ["MetadataRateLimitError"] = "يتلقى TMDB طلبات كثيرة. انتظر قليلًا ثم أعد المحاولة.",
        ["MetadataNetworkError"] = "تعذر الوصول إلى TMDB. تحقق من اتصال الإنترنت ثم أعد المحاولة.",
        ["MetadataTimeoutError"] = "انتهت مهلة طلب TMDB. أعد المحاولة.",
        ["MetadataApiError"] = "تعذر على TMDB إكمال الطلب. حاول مرة أخرى لاحقًا.",
        ["MetadataInvalidResponseError"] = "أعاد TMDB استجابة غير قابلة للقراءة. أعد المحاولة.",
        ["MetadataNotFoundError"] = "لم يعد هذا العنصر متاحًا على TMDB. ابحث عن مطابقة أخرى.",
        ["MetadataIncompleteError"] = "لم يُرجع TMDB كل التفاصيل المطلوبة. لم تتغير المطابقة. أعد المحاولة.",
        ["MetadataStaleRequestError"] = "تغير هذا السجل أثناء تحميل البيانات. راجع السجل الحالي ثم أعد المحاولة.",
        ["MetadataCancelled"] = "أُلغي طلب البيانات الوصفية.",
        ["MetadataUnexpectedError"] = "تعذر إكمال العملية. أعد المحاولة.",
        ["RelinkFailedHelp"] = "تعذرت إعادة ربط الملف. اختر ملفًا متاحًا بالحجم المتوقع وغير مرتبط بسجل آخر، ثم أعد المحاولة.",
        ["CrashTempTitle"] = "ملفات مؤقتة تحتاج إلى مراجعة",
        ["CrashTempHelp"] = "عُثر على {0} ملف يحتمل أنه ناتج عن نقل انقطع. لم تُغيّر الملفات أو تُحذف؛ راجعها مع سجل العمليات قبل اتخاذ أي إجراء.",
