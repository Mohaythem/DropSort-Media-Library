...
from dropsort.ui.common.native_title_bar import apply_native_title_bar
...
class MainWindow(QMainWindow):
    ...
    def __init__(
        ...
        *,
        ...
        self._native_title_bar_theme = (
            application.property("dropsortTheme")
            if application is not None and application.property("dropsortTheme")
            else "slate"
        )
        self._current_section = ""
        self._initial_library_activation_pending = False
        ...
        self._sidebar_top_row.setFixedHeight(68)
        ...
        if load_on_show:
            ...
            # Tests and embedders can skip the initial catalog query while the
            # shell still starts in a coherent, interactive Library section.
    ...
    def _apply_native_title_bar_theme(self) -> tuple[int, ...]:
        return apply_native_title_bar(
            self,
            self._native_title_bar_theme,
    ...
    def show_library(self) -> None:
        if (
            self._current_section == "library"
            and not self._initial_library_activation_pending
        ):
            return
        self._initial_library_activation_pending = False
    ...
    def _theme_changed(self, theme) -> None:
        ...
        self._native_title_bar_theme = theme
        self._apply_native_title_bar_theme()
        refresh_fluent_icons(self)
