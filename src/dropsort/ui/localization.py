...
class TextId(StrEnum):
    ...
    ACCESSIBILITY_LIBRARY_SEARCH = "accessibility.library_search"
    ACCESSIBILITY_MY_LISTS_SEARCH = "accessibility.my_lists_search"
    ACCESSIBILITY_MY_LISTS_EMPTY = "accessibility.my_lists_empty"
    ACCESSIBILITY_MOVIE_OPEN_DETAILS = "accessibility.movie_open_details"
    ACCESSIBILITY_MOVIE_FULL_TITLE = "accessibility.movie_full_title"
    ACCESSIBILITY_TMDB_RATING = "accessibility.tmdb_rating"
    ACCESSIBILITY_DESTINATION_FILENAME = "accessibility.destination_filename"
    ACCESSIBILITY_CHECK_PROGRESS = "accessibility.check_progress"
    ACCESSIBILITY_CHECK_PERCENTAGE = "accessibility.check_percentage"
    ACCESSIBILITY_CHECK_CANCEL = "accessibility.check_cancel"
    ...
    LIBRARY_RECONCILIATION_PROGRESS = "library.reconciliation_progress"
    ...
    RECOVERY_RESULT_INVALID = "history.recovery_result_invalid"
    ...
    HISTORY_OPERATION_ERROR = "history.operation_error"
...
_ENGLISH: dict[TextId, str] = {
    ...
    TextId.NAV_PERSONAL_LIBRARY: "My Lists",
    ...
    TextId.ACCESSIBILITY_LIBRARY_SEARCH: "Library search",
    TextId.ACCESSIBILITY_MY_LISTS_SEARCH: "My Lists search",
    TextId.ACCESSIBILITY_MY_LISTS_EMPTY: "My Lists empty state",
    TextId.ACCESSIBILITY_MOVIE_OPEN_DETAILS: "Open details for {title}",
    TextId.ACCESSIBILITY_MOVIE_FULL_TITLE: "Full movie title",
    TextId.ACCESSIBILITY_TMDB_RATING: "TMDB rating",
    TextId.ACCESSIBILITY_DESTINATION_FILENAME: "Destination filename",
    TextId.ACCESSIBILITY_CHECK_PROGRESS: "Check Library progress",
    TextId.ACCESSIBILITY_CHECK_PERCENTAGE: "Check Library progress percentage",
    TextId.ACCESSIBILITY_CHECK_CANCEL: "Cancel Check Library",
    TextId.TMDB_METADATA: "TMDB Metadata",
    TextId.TMDB_NOT_CONFIGURED: "Not configured",
    TextId.TMDB_ENVIRONMENT: "Configured through an environment variable",
    ...
    TextId.TMDB_SAVE_SESSION: "Use for This Session",
    ...
    TextId.LIBRARY_DATA_NOTICE: "Remove cataloged movies and cached metadata. Physical movie files are never changed.",
    ...
    TextId.CLEAR_LIBRARY_RESULT: "Library cleared. Movies removed: {movies}; media-file links removed: {files}.",
    ...
    TextId.LIBRARY_COUNT: "Movies: {count}",
    TextId.LIBRARY_COUNT_FILTERED: 'Matches for "{query}": {count}',
    ...
    TextId.LIBRARY_RECONCILIATION_PROGRESS: "Checking library files: {checked} / {total} | Present: {present} | Missing: {missing} | Errors: {errors}",
    TextId.MISSING_FILE: "Missing file",
    TextId.MISSING_FILES: "Missing files: {count}",
    ...
    TextId.DETAILS_YOUR_LIBRARY: "My Lists",
    TextId.DETAILS_PREFERENCE_GROUP: "Your Preference",
    TextId.DETAILS_WATCHLIST_GROUP: "Watchlist",
    TextId.DETAILS_WATCHING_GROUP: "Watch Activity",
    TextId.DETAILS_LIKE: "Like",
    TextId.DETAILS_BLACKLIST: "Exclude",
    TextId.DETAILS_CLEAR_PREFERENCE: "Clear Choice",
    TextId.DETAILS_ADD_WATCHLIST: "Add to Watchlist",
    TextId.DETAILS_IN_WATCHLIST: "In Watchlist",
    TextId.DETAILS_MARK_WATCHED: "Mark as Watched",
    TextId.DETAILS_MARK_WATCHED_DATE: "Record Watch on Date",
    TextId.DETAILS_WATCHED_COUNT: "Times watched: {count}",
    ...
    TextId.DETAILS_PERSONAL_LOAD_ERROR: "Your activity for this movie could not be loaded. Please try again.",
    TextId.DETAILS_PERSONAL_SAVE_ERROR: "Your change could not be saved. The previous state was restored.",
    ...
    TextId.PERSONAL_LIBRARY_HEADING: "My Lists",
    TextId.PERSONAL_SEARCH_PLACEHOLDER: "Search this list...",
    TextId.PERSONAL_TAB_WATCHLIST: "Watchlist",
    TextId.PERSONAL_TAB_READY: "Ready to Watch",
    TextId.PERSONAL_TAB_LIKED: "Liked",
    TextId.PERSONAL_TAB_BLACKLISTED: "Excluded",
    ...
    TextId.PERSONAL_EMPTY_BLACKLISTED: "No excluded movies.",
    TextId.PERSONAL_EMPTY_BLACKLISTED_DESCRIPTION: "Movies you exclude will appear here.",
    TextId.PERSONAL_LOADING: "Loading My Lists...",
    TextId.PERSONAL_LOAD_ERROR: "My Lists could not be loaded. Please try again.",
    ...
    TextId.ADD_MOVIES_GUIDANCE: "Choose a local folder to scan. DropSort identifies possible movies; you explicitly approve each addition.",
    ...
    TextId.ADD_MOVIES_ITEMS: "Items: {count}",
    ...
    TextId.SEARCH_MANUALLY: "Search TMDB",
    ...
    TextId.IMPORT_MANUAL_SELECTED: "Match selected",
    ...
    TextId.SCAN_PROGRESS_ROWS: "Preparing movies for review...",
    ...
    TextId.SCAN_TV_SKIPPED_SUFFIX: " TV episodes skipped: {count}.",
    ...
    TextId.IMPORT_TV_EXPLANATION: "DropSort supports movie imports only, so this TV episode was skipped.",
    ...
    TextId.IMPORT_AUTH_EXPLANATION: "TMDB is not configured, or the token was rejected. Add a TMDB Read Access Token in Settings to enable movie metadata and matching.",
    TextId.IMPORT_RATE_EXPLANATION: "TMDB received too many requests. Wait briefly, then scan again.",
    ...
    TextId.HISTORY_UNLINKED: "Operation not linked to a movie",
    TextId.HISTORY_REVERSE: "Reverse operation",
    TextId.HISTORY_COPY: "Copy Log",
    TextId.HISTORY_SAVE: "Save Log",
    TextId.HISTORY_SELECT: "Se" + "lect operation",
    TextId.HISTORY_COPY_EMPTY: "Se" + "lect an operation to copy.",
    TextId.HISTORY_COPY_SUCCESS: "Operations log copied to the clipboard.",
    ...
    TextId.RECOVERY_RESULT_INVALID: "DropSort received an invalid recovery result.",
    ...
    TextId.HISTORY_OPERATION_ERROR: "Operation error",
    TextId.CHECK_FILES_TITLE: "Check Library",
    TextId.CHECK_FILES_READY: "Ready to check library files and movie metadata.",
    TextId.CHECK_FILES_CANCEL: "Cancel Check",
    TextId.CHECK_FILES_RUNNING: "Checking library files and movie metadata...",
    ...
    TextId.CHECK_LIBRARY_FAILURE_DESCRIPTION: "The library was not modified. Technical details are available in the application log.",
    TextId.CHECK_LIBRARY_CANCELLED_DESCRIPTION: "The check was cancelled. The library was not modified.",
    ...
    TextId.CHECK_LIBRARY_REPAIRED_SUMMARY: "Metadata fields repaired: {count}.",
    TextId.CHECK_LIBRARY_NEEDS_ATTENTION_SUMMARY: "Items needing attention: {count}.",
    ...
    TextId.CHECK_LIBRARY_RATE_LIMIT: "TMDB request limit reached. Try again later.",
    ...
    TextId.RELINK_CONFIRMING: "Updating the library link...",
    TextId.RELINK_VALID: "File validated. Confirm Relink to update only the library record.",
    TextId.RELINK_COMPLETE: "Relink completed. The physical file was not moved.",
    TextId.RELINK_OLD_NEW: "OLD / LAST KNOWN PATH\n{old}\n\nNEW SELECTED PATH\n{new}",
    TextId.RELINK_PREVIEW: "{paths}\n\nSize: {size} bytes\nValidation: File available; no library conflict",
    ...
    TextId.ORGANIZE_GUIDANCE: "Choose one destination, review the exact paths, then confirm the safe file operation.",
    ...
    TextId.ORGANIZE_RUNNING: "The verified file operation is running. Keep DropSort open until it finishes.",
    ...
    TextId.ORGANIZE_SAME_DRIVE: "Same-drive move: DropSort will move the file directly.",
    ...
    TextId.ORGANIZE_ERROR_UNSAFE: "This destination is outside the folders DropSort is allowed to use.",
    ...
    TextId.ORGANIZE_ERROR_EXECUTION: "DropSort could not complete the file operation. The library still points to the previous path.",
    ...
    TextId.BUSY_CLEAR: "DropSort is busy. Finish or cancel the active scan, import, library check, or poster loading before clearing the library.",
...
_ARABIC: dict[TextId, str] = {
    ...
    TextId.ACCESSIBILITY_LIBRARY_SEARCH: "البحث في المكتبة",
    TextId.ACCESSIBILITY_MY_LISTS_SEARCH: "البحث في قوائمي",
    TextId.ACCESSIBILITY_MY_LISTS_EMPTY: "حالة فارغة في قوائمي",
    TextId.ACCESSIBILITY_MOVIE_OPEN_DETAILS: "فتح تفاصيل {title}",
    TextId.ACCESSIBILITY_MOVIE_FULL_TITLE: "عنوان الفيلم الكامل",
    TextId.ACCESSIBILITY_TMDB_RATING: "تقييم TMDB",
    TextId.ACCESSIBILITY_DESTINATION_FILENAME: "اسم ملف الوجهة",
    TextId.ACCESSIBILITY_CHECK_PROGRESS: "تقدم فحص المكتبة",
    TextId.ACCESSIBILITY_CHECK_PERCENTAGE: "نسبة تقدم فحص المكتبة",
    TextId.ACCESSIBILITY_CHECK_CANCEL: "إلغاء فحص المكتبة",
    TextId.TMDB_METADATA: "بيانات TMDB",
    TextId.TMDB_NOT_CONFIGURED: "غير مُعد",
    TextId.TMDB_ENVIRONMENT: "تم الإعداد عبر متغير بيئة",
    ...
    TextId.TMDB_INVALID_TOKEN: "أدخل رمز وصول قراءة صالحًا من TMDB.",
    ...
    TextId.LIBRARY_COUNT: "عدد الأفلام: {count}",
    TextId.LIBRARY_COUNT_FILTERED: 'النتائج: {count} لـ "{query}"',
    TextId.CHECK_LIBRARY_FILES: "فحص المكتبة",
    TextId.LIBRARY_SEARCH_PLACEHOLDER: "ابحث في المكتبة...",
    ...
    TextId.LIBRARY_SEARCH_SUGGESTION: "اقتراح من أفلام المكتبة",
    TextId.LIBRARY_EMPTY: "المكتبة فارغة حاليًا.",
    TextId.LIBRARY_EMPTY_HELPER: "أضف مجلدًا محليًا لبدء إنشاء المكتبة.",
    TextId.LIBRARY_LOAD_ERROR: "تعذر على DropSort تحميل المكتبة المحلية. حاول مرة أخرى.",
    TextId.LIBRARY_RECONCILIATION_PROGRESS: "جارٍ فحص ملفات المكتبة: {checked} / {total} | موجود: {present} | مفقود: {missing} | أخطاء: {errors}",
    TextId.MISSING_FILE: "الملف غير موجود",
    TextId.MISSING_FILES: "الملفات غير الموجودة: {count}",
    ...
    TextId.DETAILS_YOUR_LIBRARY: "قوائمي",
    TextId.DETAILS_PREFERENCE_GROUP: "تفضيلك",
    TextId.DETAILS_WATCHLIST_GROUP: "قائمة المشاهدة",
    TextId.DETAILS_WATCHING_GROUP: "نشاط المشاهدة",
    TextId.DETAILS_LIKE: "أعجبني",
    TextId.DETAILS_BLACKLIST: "استبعاد",
    TextId.DETAILS_CLEAR_PREFERENCE: "مسح الاختيار",
    TextId.DETAILS_ADD_WATCHLIST: "إضافة إلى قائمة المشاهدة",
    TextId.DETAILS_IN_WATCHLIST: "في قائمة المشاهدة",
    TextId.DETAILS_MARK_WATCHED: "تسجيل مشاهدة",
    TextId.DETAILS_MARK_WATCHED_DATE: "تسجيل مشاهدة بتاريخ",
    ...
    TextId.DETAILS_PERSONAL_LOAD_ERROR: "تعذر تحميل نشاطك لهذا الفيلم. حاول مرة أخرى.",
    TextId.DETAILS_PERSONAL_SAVE_ERROR: "تعذر حفظ التغيير. تمت استعادة الحالة السابقة.",
    ...
    TextId.PERSONAL_LIBRARY_HEADING: "قوائمي",
    TextId.PERSONAL_SEARCH_PLACEHOLDER: "ابحث في هذه القائمة...",
    ...
    TextId.PERSONAL_EMPTY_BLACKLISTED: "لا توجد أفلام مستبعدة.",
    TextId.PERSONAL_EMPTY_BLACKLISTED_DESCRIPTION: "ستظهر هنا الأفلام التي تستبعدها.",
    TextId.PERSONAL_LOADING: "جارٍ تحميل قوائمي...",
    TextId.PERSONAL_LOAD_ERROR: "تعذر تحميل قوائمي. حاول مرة أخرى.",
    ...
    TextId.ADD_MOVIES_GUIDANCE: "اختر مجلدًا محليًا لفحصه. يحدد DropSort الأفلام المحتملة، ولا تتم أي إضافة إلا بتأكيدك.",
    ...
    TextId.ADD_MOVIES_ITEMS: "عدد العناصر: {count}",
    ...
    TextId.BUILDING_RESULTS: "جارٍ تجهيز الأفلام للمراجعة...",
    TextId.INVALID_SCAN_RESULT: "تلقى DropSort نتيجة فحص غير صالحة. حاول مرة أخرى.",
    ...
    TextId.IMPORT_MANUAL_SELECTED: "تم اختيار المطابقة",
    ...
    TextId.SCAN_PROGRESS_ROWS: "جارٍ تجهيز الأفلام للمراجعة...",
    ...
    TextId.SCAN_PERMISSION: "لا يملك DropSort إذن قراءة المجلد المحدد.",
    TextId.SCAN_SAFE_ERROR: "تعذر على DropSort فحص المجلد المحدد بأمان.",
    TextId.SCAN_FAILED: "تعذر على DropSort فحص المجلد المحدد. حاول مرة أخرى.",
    TextId.SCAN_TV_SKIPPED_SUFFIX: " تم تخطي حلقات تلفزيونية: {count}.",
    ...
    TextId.IMPORT_TV_EXPLANATION: "يدعم DropSort استيراد الأفلام فقط، لذلك تم تخطي هذه الحلقة التلفزيونية.",
    TextId.IMPORT_UNKNOWN_EXPLANATION: "تعذر تصنيف اسم ملف الفيديو المدعوم كفيلم.",
    TextId.IMPORT_DISCOVERY_EXPLANATION: "تعذر على DropSort قراءة هذا العنصر بأمان، لذلك تم تخطيه.",
    TextId.IMPORT_AUTH_EXPLANATION: "لم يتم إعداد TMDB أو رُفض الرمز. أضف رمز وصول قراءة من TMDB في الإعدادات لتفعيل بيانات الأفلام والمطابقة.",
    TextId.IMPORT_RATE_EXPLANATION: "تلقى TMDB طلبات كثيرة. انتظر قليلًا ثم أعد الفحص.",
    ...
    TextId.IMPORT_FAILED: "تعذر على DropSort إكمال الاستيراد. حاول مرة أخرى.",
    ...
    TextId.HISTORY_READ_ERROR: "تعذر على DropSort قراءة سجل العمليات. حاول مرة أخرى.",
    TextId.HISTORY_UNLINKED: "عملية غير مرتبطة بفيلم",
    TextId.HISTORY_REVERSE: "عملية عكسية",
    TextId.HISTORY_COPY: "نسخ السجل",
    TextId.HISTORY_SAVE: "حفظ السجل",
    ...
    TextId.HISTORY_INVALID: "تلقى DropSort بيانات غير صالحة لسجل العمليات.",
    TextId.HISTORY_INVALID_DETAILS: "تلقى DropSort تفاصيل عملية غير صالحة.",
    ...
    TextId.UNDO_INVALID: "تلقى DropSort معاينة تراجع غير صالحة.",
    TextId.UNDO_VERIFY_FAILED: "تعذر على DropSort التحقق من أهلية التراجع. حدّث السجل.",
    TextId.UNDO_PREPARE_FAILED: "تعذر على DropSort إعداد معاينة التراجع.",
    TextId.UNDO_COMPLETED: "اكتمل التراجع من خلال عملية عكسية جديدة ومسجلة.",
    ...
    TextId.UNDO_FAILED: "تعذر على DropSort إكمال عملية التراجع بأمان.",
    TextId.UNDO_FAILED_GENERIC: "تعذر على DropSort إكمال عملية التراجع.",
    TextId.RECOVERY_INVALID: "تلقى DropSort تقييم استرداد غير صالح.",
    TextId.RECOVERY_RESULT_INVALID: "تلقى DropSort نتيجة استرداد غير صالحة.",
    TextId.RECOVERY_INSPECT_FAILED: "تعذر على DropSort فحص حالة الاسترداد بأمان.",
    ...
    TextId.HISTORY_OPERATION_ERROR: "خطأ في العملية",
    TextId.CHECK_FILES_TITLE: "فحص المكتبة",
    TextId.CHECK_FILES_READY: "جاهز لفحص ملفات المكتبة والبيانات الوصفية للأفلام.",
    TextId.CHECK_FILES_CANCEL: "إلغاء الفحص",
    TextId.CHECK_FILES_RUNNING: "جارٍ فحص ملفات المكتبة والبيانات الوصفية للأفلام...",
    TextId.CHECK_FILES_CANCELLING: "جارٍ إلغاء فحص المكتبة...",
    TextId.CHECK_FILES_CANCELLED: "تم إلغاء الفحص",
    TextId.CHECK_FILES_FAILED: "تعذر على DropSort إكمال فحص المكتبة.",
    ...
    TextId.CHECK_FILES_COMPLETE: "اكتمل فحص ملفات المكتبة: موجود: {present} | مفقود: {missing} | أخطاء: {errors}",
    TextId.CHECK_FILES_DONE: "تم",
    TextId.CHECK_FILES_BACKGROUND_CANCELLED: "أُلغي فحص ملفات المكتبة في الخلفية.",
    TextId.CHECK_FILES_BACKGROUND_FAILED: "تعذر على DropSort إكمال فحص ملفات المكتبة في الخلفية.",
    ...
    TextId.CHECK_LIBRARY_HEALTHY_TITLE: "المكتبة بحالة جيدة",
    TextId.CHECK_LIBRARY_FAILURE_TITLE: "تعذر إكمال فحص المكتبة",
    TextId.CHECK_LIBRARY_FAILURE_DESCRIPTION: "لم يتم تعديل المكتبة. تتوفر التفاصيل التقنية في سجل التطبيق.",
    TextId.CHECK_LIBRARY_CANCELLED_DESCRIPTION: "تم إلغاء الفحص. لم يتم تعديل المكتبة.",
    ...
    TextId.CHECK_LIBRARY_REPAIRED_SUMMARY: "حقول البيانات التي أُصلحت: {count}.",
    TextId.CHECK_LIBRARY_NEEDS_ATTENTION_SUMMARY: "العناصر التي تحتاج إلى مراجعة: {count}.",
    ...
    TextId.CHECK_LIBRARY_RATE_LIMIT: "تم بلوغ الحد الأقصى لطلبات TMDB. حاول مرة أخرى لاحقًا.",
    ...
    TextId.RELINK_CONFIRMING: "جارٍ تحديث رابط الملف في المكتبة...",
    TextId.RELINK_VALID: "تم التحقق من الملف. أكّد إعادة الربط لتحديث سجل المكتبة فقط.",
    ...
    TextId.ORGANIZE_RUNNING: "عملية الملف المتحقق منها قيد التنفيذ. أبقِ DropSort مفتوحًا حتى تكتمل.",
    ...
    TextId.ORGANIZE_INVALID_PREVIEW: "تلقى DropSort معاينة غير صالحة. حاول مرة أخرى.",
    TextId.ORGANIZE_SAME_DRIVE: "نقل داخل محرك الأقراص نفسه: سينقل DropSort الملف مباشرةً.",
    TextId.ORGANIZE_CROSS_DRIVE: "نقل بين محركين: سينسخ DropSort الملف ويتحقق من بصمته قبل إزالة الأصل.",
    ...
    TextId.ORGANIZE_ERROR_DEST_EXISTS: "الوجهة موجودة بالفعل. اختر مجلدًا أو اسمًا آخر؛ لا يستبدل DropSort الملفات أبدًا.",
    ...
    TextId.ORGANIZE_ERROR_UNSAFE: "هذه الوجهة خارج المجلدات المسموح لـ DropSort باستخدامها.",
    TextId.ORGANIZE_ERROR_CATALOG: "تغير مسار الملف المفهرس. أعد تحميل تفاصيل الفيلم قبل التنظيم.",
    TextId.ORGANIZE_ERROR_VALIDATE: "تعذر على DropSort التحقق من الوجهة. اختر مجلدًا أو اسمًا آخر.",
    TextId.ORGANIZE_ERROR_PREPARE: "تعذر على DropSort إعداد معاينة آمنة. حاول مرة أخرى.",
    ...
    TextId.ORGANIZE_ERROR_EXECUTION: "تعذر على DropSort إكمال عملية الملف. لا تزال المكتبة تشير إلى المسار السابق.",
    TextId.ORGANIZE_ERROR_GENERIC: "تعذر على DropSort إكمال العملية. افحص الملف وحاول مرة أخرى.",
    TextId.MEDIA_MISSING_ACTION: "لم يعد ملف الوسائط متاحًا في موقعه المفهرس.",
    TextId.PLAY_FAILED: "تعذر على DropSort تشغيل هذا الفيلم. حاول مرة أخرى.",
    TextId.OPEN_FOLDER_FAILED: "تعذر على DropSort فتح هذا المجلد. حاول مرة أخرى.",
    TextId.BUSY_CLEAR: "DropSort مشغول. أنهِ أو ألغِ الفحص أو الاستيراد أو فحص المكتبة أو تحميل الملصقات قبل مسح المكتبة.",
    ...
    TextId.CLEAR_DATABASE: "تعذر على DropSort مسح المكتبة المحلية؛ بقيت بيانات الفهرس الحالية محفوظة.",
    TextId.CLEAR_FAILED: "تعذر على DropSort مسح المكتبة المحلية.",
    TextId.DETAILS_LOAD_ERROR: "تعذر على DropSort تحميل تفاصيل الفيلم. ارجع إلى المكتبة وحاول مرة أخرى.",
}
